...
func TestState_Apply_LoopOperations(t *testing.T) {
	tests := map[string]struct {
		...
		"LoopAdd": {
			op: Operation{
				Type: LoopAdd,
				Loop: &Loop{ID: "loop_1", EdgeIds: []string{"edge_1"}},
			},
			initial: State{
			...
			want: State{
				Loops: map[string]*Loop{
					"loop_1": {ID: "loop_1", EdgeIds: []string{"edge_1"}},
				},
				Counter: 2,
			},
		},
		"LoopUpdate": {
			op: Operation{
				Type:  LoopUpdate,
				ID:    "loop_1",
				Patch: map[string]any{"loopType": "R"},
			},
			initial: State{
				Loops: map[string]*Loop{
					"loop_1": {ID: "loop_1", LoopType: "B"},
				},
				Counter: 1,
			},
			want: State{
				Loops: map[string]*Loop{
					"loop_1": {ID: "loop_1", LoopType: "R"},
				},
				Counter: 1,
			},
		},
